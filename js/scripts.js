(function(root, factory){
  ...
  function processDataFile(data){
      ...
      let qt = new qtree.QuadTree(boundary, 4);
  ...
  function setGeometry(gl) {
    for (var obj in objectsAll) {
      positionVBO.push(objectsAll[obj].coord);
    }
  ...
  function setColors(gl) {
    ...
    gl.bufferData(gl.ARRAY_BUFFER, convert32Bits(colorVBO), gl.STATIC_DRAW);
  }
  informFileBox();
  return {
        main: main,
